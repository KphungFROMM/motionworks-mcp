...
def write_pou_body(
    ...
    # Remove the build cache. `tmp.sto` beside a POU is generated by MotionWorks and
    # describes the POU as it was before this write; left in place, a Rebuild can
    # pick it up and report a file error against it rather than rebuilding from the
    # container. It is regenerated, so clearing it costs nothing.
